  <div class="container-fluid" style="background-color:#e8e8e8">
        <div id="property-listings">
            ...
            <div class="row">
                <div class="col-sm-12"> 
                    <!-- Ads-->
                    <div class="brdr pad-10">
                        <div class="media">
                            <div class="col-md-12">
                                <img src="http://lorempixel.com/770/140/technics/Ads%20for%20this%20site/" class="img-responsive" alt="">
                            </div>
                        </div>
                    </div><!-- End Ads-->
                    ...
                    <div class="brdr pad-10 property-listing">
                        <div class="media">
                            ...
                            <div class="media-body fnt-smaller">
                                ...
                                <ul class="list-inline clr-535353">
                                    <li>4,820 SqFt</li>
